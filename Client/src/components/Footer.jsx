  ...
  return (
    <Container>
        <Left>
            <Logo>LOGO.</Logo>
            <Description>
                This is just a descrpition that shows nothing but a simple, funny, meaningless and long description with the intention of describing the way descriptions usually do when describing a description
            </Description>
            <SocailContainer>
